...
from save_callbacks import SaveBestCallback, SaveOnBestDistance, CurriculumCallback, \
    CurriculumDistanceCallback, CurriculumDistanceCallbackOnReward
...
if __name__ == '__main__':
    ...
    curriculum_calback = CurriculumDistanceCallbackOnReward(threshold_delta=3.5,step_distance_level=0.05,
                                                    step_to_increase=500000,
