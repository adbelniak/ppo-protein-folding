...
def train(env_id, num_timesteps, seed, policy,
    ...
    model = PPO2(policy=policy, env=env, n_steps=n_steps, nminibatches=nminibatches,
                 lam=0.95, gamma=0.99, noptepochs=4, ent_coef=.01,  tensorboard_log='../../../log',
                 learning_rate=lambda f: f * 2.5e-4, cliprange=lambda f: f * 0.1, verbose=1, full_tensorboard_log=True)
