...
if __name__ == '__main__':
    ...
    curriculum_calback = CurriculumScrambleCallback(
        threshold_delta=0.05 + settings['goal_delta'], step_distance_level=0.05, window_size=50000,
        envs=env, min_step=100000, start_value=0.85, not_to_early_threshold=100000, step_to_increase=10000000
    )
